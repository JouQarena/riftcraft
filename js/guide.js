...
(() => {
  ...
  const rollSteps = [
    ...
    { id: 'roll-speed', title: 'Try a faster bounce', copy: 'Speed switches the portraits between normal and fast movement. It starts a new roll and keeps your picks. The roll and sound still last 2.5 seconds.', task: 'Your turn · Click Speed', target: '#speedBtn', practice: true },
